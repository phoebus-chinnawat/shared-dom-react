...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/OcJSj3gLl2)
...
```sh
npx nx serve shared-dom-react-mobile
```

To create a production bundle:

```sh
npx nx build shared-dom-react-mobile
```

To see all available targets to run for a project, run:

```sh
npx nx show project shared-dom-react-mobile
```
